...
edc_folder_path = "D:/Stuff/TU Ilmenau/Masters In Media Engineering/ADSP/LSTM-Model-Energy-Decay-Curves-main/LSTM-Model-Energy-Decay-Curves-main/dataset/room_acoustic_largedataset/EDC"
room_features_path = "D:/Stuff/TU Ilmenau/Masters In Media Engineering/ADSP/LSTM-Model-Energy-Decay-Curves-main/LSTM-Model-Energy-Decay-Curves-main/dataset/room_acoustic_largedataset/roomFeaturesDataset.csv"
...
# ==========================================================
# FINAL LSTM PREDICTION EXPORT (FOR PAPER FIGURES)
# ==========================================================

print("Exporting LSTM predictions for comparison figures...")
...
with torch.no_grad():
    for X, y in val_loader:   # <-- correct loader
        preds = model(X)
...
# Save EXACTLY where you said
np.save(
    "D:/Stuff/TU Ilmenau/Masters In Media Engineering/ADSP/"
    "LSTM-Model-Energy-Decay-Curves-main/"
    "LSTM-Model-Energy-Decay-Curves-main/"
    "LSTM Model/training/lstm_predictions.npy",
    all_preds
)
...
np.save(
    ...
    "LSTM-Model-Energy-Decay-Curves-main/"
    "LSTM-Model-Energy-Decay-Curves-main/"
    "LSTM Model/training/gt_edc.npy",
    all_targets
)

print("Saved:")
print(" - lstm_predictions.npy", all_preds.shape)
print(" - gt_edc.npy", all_targets.shape)
